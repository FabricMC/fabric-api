...
/// the stack itself.
///
/// Custom damage handlers can be set with [FabricItem.Properties#customDamage].
@FunctionalInterface
public interface CustomDamageHandler {
	...
	/// Calling `breakCallback` breaks the item, bypassing the vanilla logic. The return value is
