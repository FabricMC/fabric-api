...
public final class DefaultCustomIngredients {
	...
	///
	/// Use [DataComponentPatch#builder()] to add or remove components.
	...
	///
	/// This does not check for the default component of the item stack that remains unchanged.
	...
	///
	/// @see #components(Ingredient, DataComponentPatch)
	/// @throws IllegalArgumentException if `stack` has no changed components
	...
	/// Creates an ingredient that wraps another ingredient to also check for stack's
	/// [custom data][net.minecraft.core.component.DataComponents#CUSTOM_DATA].
