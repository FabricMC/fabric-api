...
public interface FabricIngredient {
	...
	///
	/// If `false`, {@linkplain Ingredient#test testing this ingredient} with an item stack must be equivalent to checking whether
	...
	///
	/// If `true`, the ingredient must always be tested using [Ingredient#test(ItemStack)].
