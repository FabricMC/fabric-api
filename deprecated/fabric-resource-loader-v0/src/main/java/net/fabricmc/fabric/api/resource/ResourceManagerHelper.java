...
public interface ResourceManagerHelper {
	...
	/// Register a resource reload listener for a given resource manager type.
	///
	/// Note: This is only supported for server data reload listeners.
	///
	...
	/// @deprecated Use [net.fabricmc.fabric.api.resource.v1.ResourceLoader#REGISTRY_LOOKUP_KEY] with [net.minecraft.server.packs.resources.PreparableReloadListener.SharedState],
	/// or [net.fabricmc.fabric.api.resource.v1.DataResourceLoader#registerReloadListener(Identifier, Function)] instead.
	@Deprecated
	...
	/// @deprecated See [ResourceLoader#registerBuiltinPack(Identifier, ModContainer, PackActivationType)]
	@Deprecated
	...
	/// @param activationType the activation type of the resource pack
	/// @return `true` if successfully registered the resource pack, else `false`
	/// @deprecated See [ResourceLoader#registerBuiltinPack(Identifier, ModContainer, Component, PackActivationType)]
	@Deprecated
	...
	/// @param activationType the activation type of the resource pack
	/// @return `true` if successfully registered the resource pack, else `false`
	/// @deprecated Use [#registerBuiltinResourcePack(Identifier, ModContainer, Component, ResourcePackActivationType)] instead.
	@Deprecated
	...
	///
	/// Note about the enabled by default parameter: a resource pack cannot be enabled by default, only data packs can.
	...
	/// @return `true` if successfully registered the resource pack, else `false`
	/// @deprecated Please use [#registerBuiltinResourcePack(Identifier, ModContainer, ResourcePackActivationType)] instead, the `sub path` should be removed in a future
