...
public class HudRenderEventsTests implements ClientModInitializer {
	...
	public void onInitializeClient() {
		HudLayerRegistrationCallback.EVENT.register(layeredDrawer -> layeredDrawer.addLayerBefore(IdentifiedLayer.MISC_OVERLAYS, Identifier.of("fabric", "test_before_misc_overlay"), (context, tickCounter) -> {
		...
		}).addLayerAfter(IdentifiedLayer.MISC_OVERLAYS, Identifier.of("fabric", "test_after_misc_overlay"), (context, tickCounter) -> {
		...
		}).addLayerAfter(IdentifiedLayer.EXPERIENCE_LEVEL, Identifier.of("fabric", "test_after_experience_level"), (context, tickCounter) -> {
		...
		}).addLayerBefore(IdentifiedLayer.DEMO_TIMER, Identifier.of("fabric", "test_before_demo_timer"), (context, tickCounter) -> {
		...
		}).addLayerBefore(IdentifiedLayer.CHAT, Identifier.of("fabric", "test_before_chat"), (context, tickCounter) -> {
		...
		}).addLayerAfter(IdentifiedLayer.SUBTITLES, Identifier.of("fabric", "test_after_subtitles"), (context, tickCounter) -> {
