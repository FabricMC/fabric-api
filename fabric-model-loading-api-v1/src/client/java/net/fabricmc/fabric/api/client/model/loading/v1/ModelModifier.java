...
/// Example use cases:
///
///   - Overriding the model for a particular block state - check if the given block state matches the desired block
///     state. If so, return your desired model, otherwise return the given model.
...
///
/// Any event may be invoked concurrently with other invocations of the same event or other events, subject to
...
public final class ModelModifier {
	...
	public interface OnLoad {
		...
		/// @return the model that should be used in this scenario. If no changes are needed, just return `model` as-is.
