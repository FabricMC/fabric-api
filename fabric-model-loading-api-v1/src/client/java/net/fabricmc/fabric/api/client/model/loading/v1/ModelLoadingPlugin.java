...
public interface ModelLoadingPlugin {
	...
	interface Context {
		...
		/// [FabricModelManager#getModel(ExtraModelKey)].
		///
		/// Dependency gathering and baking is performed by an [UnbakedExtraModel]. This allows you to depend
		/// on multiple models files at once, baking them into a single dynamic model. To load a single model, then
		/// [SimpleUnbakedExtraModel] may be used.
		///
		...
		///
		/// Replacements done by listeners of this callback affect child models (that is, models whose
