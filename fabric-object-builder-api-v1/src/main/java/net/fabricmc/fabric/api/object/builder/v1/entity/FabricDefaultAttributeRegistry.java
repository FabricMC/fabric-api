...
///
/// All living entity types must have default attributes registered. See
/// [EntityType.Builder] for utility on entity type registration in general.
///
/// A registered default attribute for an entity type can be retrieved through
/// [net.minecraft.world.entity.ai.attributes.DefaultAttributes#getSupplier(EntityType)].
///
...
public final class FabricDefaultAttributeRegistry {
	...
	/// can be checked at [net.minecraft.world.entity.ai.attributes.DefaultAttributes#hasSupplier(EntityType)].
	///
