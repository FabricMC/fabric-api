...
public interface FabricEntityType {
	...
	interface Builder<T extends Entity> {
		...
		///
		/// This entity's mob category will automatically be set to [MobCategory#MISC].
		///
		...
		/// A builder for additional properties of a living entity, use via [#createLiving(EntityType.EntityFactory, MobCategory, UnaryOperator)].
		...
		/// A builder for additional properties of a mob entity, use via [#createMob(EntityType.EntityFactory, MobCategory, UnaryOperator)].
