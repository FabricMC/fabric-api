...
public interface FluidVariantRenderHandler {
	...
	/// They are already added by [FluidVariantRendering#getTooltip].
	...
	///
	/// Null may be returned if the fluid variant should not be rendered, but if an array is returned it must have at least two entries and
