...
/// A subset of a [Transaction] that lets participants properly take part in transactions, manage their state,
...
public interface TransactionContext {
	...
	/// @return The nesting depth of this transaction: 0 if it was opened with [Transaction#openOuter],
	/// 1 if its parent was opened with [Transaction#openOuter], and so on...
	/// @throws IllegalStateException If this function is not called on the thread this transaction was opened in.
	int nestingDepth();
	...
	interface CloseCallback {
		...
		///
		/// @param transaction The closed transaction. Only [#nestingDepth], [#getOpenTransaction] and [#addOuterCloseCallback]
		///                    may be called on that transaction.
		///                    [#addCloseCallback] may additionally be called on parent transactions
		///                    (accessed through [#getOpenTransaction] for lower nesting depths).
	...
	/// and after callbacks registered with [#addCloseCallback] are ran.
