...
public final class ClientSendMessageEvents {
	...
	///
	/// If a listener returned `false`, the message will not be sent,
	/// the remaining listeners will not be called (if any), and
	/// [#CHAT_CANCELED] will be triggered instead of [#MODIFY_CHAT].
	...
	///
	/// If a listener returned `false`, the command will not be sent,
	/// the remaining listeners will not be called (if any), and
	/// [#COMMAND_CANCELED] will be triggered instead of [#MODIFY_COMMAND].
	...
	/// An event triggered when sending a command is canceled with [#ALLOW_COMMAND].
	/// The command string does not include a slash at the beginning.
	...
	public interface AllowChat {
		...
		/// typically from a client GUI. Returning `false`
		/// prevents the message from being sent, and
		/// [#CHAT_CANCELED] will be triggered instead of [#MODIFY_CHAT].
		///
		/// @param message the message that will be sent to the server
		/// @return `true` if the message should be sent, otherwise `false`
	...
	public interface AllowCommand {
		...
		/// @return `true` if the command should be sent, otherwise `false`
	...
	public interface ChatCanceled {
		/// Called when sending a chat message is canceled with [#ALLOW_CHAT].
		///
	...
	public interface CommandCanceled {
		/// Called when sending a command is canceled with [#ALLOW_COMMAND].
		/// The command string does not include a slash at the beginning.
		///
