...
/// See [ApiLookupMap] for a usage example.
///
...
/// Also, keys are compared by reference (`==`) and not using [Object#equals].
///
/// @param <K> The key type of the map, compared by reference (`==`).
...
public interface ApiProviderMap<K, V> {
	...
	/// associate it with the given value and return `null`, else return the current value.
	///
