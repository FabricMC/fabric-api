...
public final class ConventionalEnchantmentTags {
	...
	/// quality of drops from blocks, such as [net.minecraft.world.item.enchantment.Enchantments#FORTUNE].
	public static final TagKey<Enchantment> INCREASE_BLOCK_DROPS = register("increase_block_drops");
	/// A tag containing enchantments that increase the amount or
	/// quality of drops from entities, such as [net.minecraft.world.item.enchantment.Enchantments#LOOTING].
	...
	/// Example: Reducing falling speeds ([net.minecraft.world.item.enchantment.Enchantments#FEATHER_FALLING]) or allowing walking on water ([net.minecraft.world.item.enchantment.Enchantments#FROST_WALKER])
