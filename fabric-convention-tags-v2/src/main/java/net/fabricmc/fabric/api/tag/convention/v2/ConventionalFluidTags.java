...
/// See [net.minecraft.tags.FluidTags] for vanilla tags.
...
///
/// (See [net.fabricmc.fabric.api.transfer.v1.fluid.FluidConstants] for the correct droplet rates for containers)
