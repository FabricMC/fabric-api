...
/// See [net.minecraft.tags.BiomeTags] for vanilla tags.
...
public final class ConventionalBiomeTags {
	...
	/// [net.minecraft.tags.BiomeTags#HAS_STRONGHOLD] so
	...
	/// For snowy plains-like biomes, see [ConventionalBiomeTags#IS_SNOWY_PLAINS].
	public static final TagKey<Biome> IS_PLAINS = register("is_plains");
	/// For snowy plains-like biomes.
	/// For warmer plains-like biomes, see [ConventionalBiomeTags#IS_PLAINS].
	public static final TagKey<Biome> IS_SNOWY_PLAINS = register("is_snowy_plains");
	/// Biomes densely populated with deciduous trees.
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_FOREST])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_TAIGA])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_HILL])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_JUNGLE])
	public static final TagKey<Biome> IS_JUNGLE = register("is_jungle");
	/// Biomes that spawn as a savanna.
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_SAVANNA])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_BADLANDS])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_BEACH])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_RIVER])
	public static final TagKey<Biome> IS_RIVER = register("is_river");
	/// Biomes that spawn as part of the world's oceans.
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_OCEAN])
	...
	/// (This is for people who want to tag their biomes without getting side effects from [ConventionalBiomeTags#IS_DEEP_OCEAN])
	...
	/// For biomes where lot of ice is present, see [ConventionalBiomeTags#IS_ICY].
	...
	/// For biomes where snow alone spawns, see [ConventionalBiomeTags#IS_SNOWY].
