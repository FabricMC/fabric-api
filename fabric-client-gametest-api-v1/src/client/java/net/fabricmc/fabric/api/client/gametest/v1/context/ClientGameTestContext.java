...
public interface ClientGameTestContext {
	...
	/// Waits for a predicate to be true. Fails if the predicate is not satisfied after `timeout` ticks. If
	/// `timeout` is [#NO_TIMEOUT], there is no timeout.
	///
	/// @param predicate The predicate to check
	...
	/// Waits for the given screen class to be shown. If `screenClass` is `null`, waits for the current
	/// screen to be `null`. Fails if the screen does not open after [#DEFAULT_TIMEOUT] ticks.
	///
	...
	///
	/// @param options The [TestScreenshotOptions] to take the screenshot with
	/// @return The [Path] to the screenshot
	...
	/// fuzzy match, see [TestScreenshotComparisonOptions] for details.
	///
	/// @param templateImage The path to the template image. The template image should be in the `templates`
	...
	/// method searches with a fuzzy match, see [TestScreenshotComparisonOptions] for details.
	///
	/// @param templateImage The path to the template image. The template image should be in the `templates`
	///                      directory in the resources directory of the mod which registers the gametest
	...
	/// Restores all game options in [Minecraft#options] to their default values for client gametests. This
