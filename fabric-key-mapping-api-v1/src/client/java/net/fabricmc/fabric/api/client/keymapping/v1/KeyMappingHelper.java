 ...
 *
 * <pre>{@code
 * KeyMapping left = KeyMappingHelper.registerKeyMapping(new KeyMapping("key.example.left", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_P, KeyMapping.Category.MISC));
 * KeyMapping right = KeyMappingHelper.registerKeyMapping(new KeyMapping("key.example.right", InputUtil.Type.KEYSYM, GLFW.GLFW_KEY_U, KeyMapping.Category.MISC));
 * }</pre>
 *
 * @see KeyMapping
