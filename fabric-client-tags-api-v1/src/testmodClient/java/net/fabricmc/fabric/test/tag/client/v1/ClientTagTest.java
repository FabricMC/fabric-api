...
public class ClientTagTest implements ClientModInitializer {
	...
	protected static final Identifier BUILT_IN_PACK_ID = Identifier.of(MOD_ID, "test");
	protected static final Identifier ADD_BACK_MELON_PACK_ID = Identifier.of(MOD_ID, "add_back_melon");
