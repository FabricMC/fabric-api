...
public interface FabricLayerRenderState {
	 ...
	 * {@link ItemStackRenderState.LayerRenderState#setQuads(ItemQuads)} and will be rendered after any
	 * {@linkplain ItemStackRenderState.LayerRenderState#setQuads(ItemQuads)}  vanilla quads} when this layer is rendered. Vertex
	 ...
	 * be used to add positions of {@linkplain ItemStackRenderState.LayerRenderState#setQuads(ItemQuads)}  vanilla quads}). Adding quads
