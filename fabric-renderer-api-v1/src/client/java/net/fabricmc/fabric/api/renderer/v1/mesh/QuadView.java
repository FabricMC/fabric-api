...
public interface QuadView {
	...
	/// Copies the geometric position of the given vertex to the given target. If the target is `null`, a new
	/// [Vector3f] will be allocated and returned.
	...
	/// Copies the texture coordinates of the given vertex to the given target. If the target is `null`, a new
	/// [Vector2f] will be allocated and returned.
