...
public interface FabricModelBlockRenderer {
	 ...
	 */
	default void tesselateBlock(BlockAndTintGetter level, BlockStateModel model, BlockState state, BlockPos pos, PoseStack poseStack, BlockMultiBufferSource bufferSource, Predicate<ChunkSectionLayer> layerFilter, boolean cull, long seed, int overlay) {
		Renderer.get().tesselateBlock((ModelBlockRenderer) this,
				level, model, state, pos, poseStack,
				bufferSource, layerFilter, cull, seed, overlay);
	}
	 ...
	 * @param overlay The overlay value to pass to output {@link VertexConsumer}s.
	 */
	default void tesselateBlock(BlockAndTintGetter level, BlockStateModel model, BlockState state, BlockPos pos, PoseStack poseStack, BlockMultiBufferSource bufferSource, boolean cull, long seed, int overlay) {
		Renderer.get().tesselateBlock((ModelBlockRenderer) this,
				level, model, state, pos, poseStack,
				bufferSource, null, cull, seed, overlay);
	}
