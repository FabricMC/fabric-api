...
public final class EntityElytraEvents {
	...
	///
	/// Items that wish to enable custom elytra flight when worn in the chest equipment slot can add the [net.minecraft.core.component.DataComponents#GLIDER] component to an item.
