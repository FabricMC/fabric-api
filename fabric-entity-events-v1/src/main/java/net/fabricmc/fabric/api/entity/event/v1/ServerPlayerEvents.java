...
public final class ServerPlayerEvents {
	...
	///
	/// This event is called **after** the old player is removed and untracked, but **before** the new player is added and tracked.
	...
	///
	/// This event is called on the server thread after the player has fully been loaded into the world.
	...
	///
	/// This event is called on the server thread before the player has been saved and removed from the world.
	...
	///
	/// @deprecated Use the more general [ServerLivingEntityEvents#ALLOW_DEATH] event instead and check for `instanceof ServerPlayer`.
	@Deprecated
