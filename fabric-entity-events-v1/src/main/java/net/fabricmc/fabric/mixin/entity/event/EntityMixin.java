...
abstract class EntityMixin {
	...
	private Entity afterDimensionChanged(Entity instance, ServerLevel oldLevel, ServerLevel newLevel, TeleportTransition transition, Operation<Entity> original) {
		...
		Entity ret = original.call(instance, oldLevel, newLevel, transition);
