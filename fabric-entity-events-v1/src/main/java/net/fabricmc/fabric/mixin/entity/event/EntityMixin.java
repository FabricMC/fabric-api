...
abstract class EntityMixin {
	...
	private Entity afterDimensionChanged(Entity instance, ServerLevel sourceWorld, ServerLevel targetWorld, TeleportTransition teleportTarget, Operation<Entity> original) {
