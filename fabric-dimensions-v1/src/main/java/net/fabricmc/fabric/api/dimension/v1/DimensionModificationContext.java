...
/**
 * Allows {@link DimensionType} properties to be modified.
 */
public interface DimensionModificationContext {
	/**
	 * Returns the modification context for the dimensions environment attributes.
	 */
