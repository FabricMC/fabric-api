...
public final class ContentRegistryTest implements ModInitializer {
	...
	public void onInitialize() {
		...
		//  - copper ore, iron ore, gold ore, and diamond ore can be waxed into their deepslate variants ~~and scraped back again~~ NOTE: scraping doesn't work at the moment due to new vanilla changes with block transformers!
		//  - ~~aforementioned ores can be scraped from diamond -> gold -> iron -> copper~~ NOTE: doesn't work at the moment due to new vanilla changes with block transformers!
