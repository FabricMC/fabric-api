...
import net.fabricmc.fabric.impl.scheduler.v1.node.DelayNode;
import net.fabricmc.fabric.impl.scheduler.v1.node.SchedulerNode;

public final class DelayInstruction implements SchedulerInstructionImpl {
	private final String stateId;
	private final IntSupplier ticks;

	public DelayInstruction(String stateId, IntSupplier ticks) {
	...
	public SchedulerNode compile(SchedulerNode successor, Map<String, SchedulerNode> nodeByStateId, Map<@Nullable String, List<UnboundExitNode>> unboundExitNodes) {
		DelayNode node = new DelayNode(stateId, ticks, successor);
