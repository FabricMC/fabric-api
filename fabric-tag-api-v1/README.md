...
*Tag entry removals* may be used to just remove entries you may not want in a tag.
...
All tag files contain an additional field with the key `fabric:remove`, which is an array of entries you
