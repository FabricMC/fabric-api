...
public class TagTest implements ModInitializer {
	...
	public static final Identifier REMOVE_AND_ADD_TEST_PACK_ID = Identifier.of(MOD_ID, "remove_and_add_test");
	public static final Identifier NON_PRESENT_REMOVAL_PACK_ID = Identifier.of(MOD_ID, "non_present_removal");
