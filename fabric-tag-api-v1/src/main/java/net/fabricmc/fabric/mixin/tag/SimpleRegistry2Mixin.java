...
import net.fabricmc.fabric.impl.tag.TagAliasEnabledRegistry;

@Mixin(targets = "net.minecraft.registry.SimpleRegistry$2")
abstract class SimpleRegistry2Mixin<T> implements TagAliasEnabledRegistry {
	...
	public void fabric_applyTagAliases(Map<TagKey<?>, Set<TagKey<?>>> aliasGroups) {
		((TagAliasEnabledRegistry) getBase()).fabric_applyTagAliases(aliasGroups);
	}
}
