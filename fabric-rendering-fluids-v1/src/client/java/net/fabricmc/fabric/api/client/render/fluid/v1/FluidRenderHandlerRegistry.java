...
public interface FluidRenderHandlerRegistry {
	...
	/// Get a [FluidRenderHandler] for a given Fluid. Supports vanilla and
	/// Fabric fluids.
	///
	...
	/// Get a [FluidRenderHandler] for a given Fluid, if it is not the
	...
	///
	/// Note that most fluids have a still and a flowing type, and a
	...
	/// Register a [FluidRenderHandler] for two given Fluids, usually a
