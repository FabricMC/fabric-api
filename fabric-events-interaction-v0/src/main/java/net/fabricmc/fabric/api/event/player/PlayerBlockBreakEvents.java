...
public final class PlayerBlockBreakEvents {
	...
	/// action is cancelled and [#CANCELED] event is fired. Otherwise, the
	...
	///
	/// Only called on a logical server. For client side see [net.fabricmc.fabric.api.event.client.player.ClientPlayerBlockBreakEvents#AFTER]
	...
	public interface Before {
		...
		/// @param blockEntity the block entity **before** the block is broken, can be `null`
		/// @return `false` to cancel block breaking action, or `true` to pass to next listener
	...
	public interface After {
		...
		/// @param blockEntity the block entity of the broken block, can be `null`
	...
	public interface Canceled {
		...
		/// @param blockEntity the block entity of the block that was going to be broken, can be `null`
