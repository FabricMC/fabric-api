...
public final class EntityTrackingEvents {
	...
	/// This event is called after the entity's {@linkplain Entity#getAddEntityPacket(net.minecraft.server.level.ServerEntity) spawn packet} is sent to the player.
