...
public final class ClientConfigurationNetworking {
	 ...
	 * @return {@code true} if the connected server has declared the ability to receive a packet on the specified channel, {@code false} if the client is not in game.
	 */
