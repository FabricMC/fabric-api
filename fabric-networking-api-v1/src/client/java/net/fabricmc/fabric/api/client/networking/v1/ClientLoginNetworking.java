...
public final class ClientLoginNetworking {
	...
	public interface LoginQueryRequestHandler {
		...
		/// If your request processes instantly, you may use [CompletableFuture#completedFuture(Object)] to wrap your response for immediate sending.
		///
		...
		/// If the future contains `null`, then the server will be notified that the client did not understand the query.
