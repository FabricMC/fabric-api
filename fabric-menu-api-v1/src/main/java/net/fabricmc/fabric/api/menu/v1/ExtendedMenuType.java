...
/// A [MenuType] for an extended menus that
...
public class ExtendedMenuType<T extends AbstractContainerMenu, D> extends MenuType<T> {
	...
	///
	/// @param factory the menu factory used for [#create(int, Inventory, Object)]
	...
	/// @throws UnsupportedOperationException always; use [#create(int, Inventory, Object)]
	/// @deprecated Use [#create(int, Inventory, Object)] instead.
	@Deprecated
	@Override
