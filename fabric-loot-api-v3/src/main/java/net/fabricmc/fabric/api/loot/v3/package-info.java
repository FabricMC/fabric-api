...
/// ## Events
/// [net.fabricmc.fabric.api.loot.v3.LootTableEvents] has events to modify existing loot tables,
/// or outright replace them with a new loot table.
///
/// You can also check where loot tables are coming from in those events with
/// [net.fabricmc.fabric.api.loot.v3.LootTableSource]. This is useful when you only want to modify
